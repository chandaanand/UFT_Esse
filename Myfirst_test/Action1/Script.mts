...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Num_Of_Cart_Items").Highlight
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Remove_Cart_Items").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement 2")_;_script infofile_;_ZIP::ssf5.xml_;_
