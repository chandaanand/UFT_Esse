...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Remove_prod").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement 2")_;_script infofile_;_ZIP::ssf7.xml_;_
